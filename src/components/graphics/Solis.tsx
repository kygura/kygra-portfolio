interface SolisProps { className?: string }
export const Solis = ({ className }: SolisProps) => {
  return (
    <svg viewBox="0 0 560 280" fill="none" className={className} aria-hidden="true">
      <g stroke="currentColor" strokeWidth="1">
        ...
        <polygon points="52.5,35 54.5,52.5 52.5,70 50.5,52.5" fill="currentColor" />
        <polygon points="35,52.5 52.5,50.5 70,52.5 52.5,54.5" fill="currentColor" />
        ...
        <ellipse cx="507.5" cy="227.5" rx="14" ry="5" transform="rotate(-45 507.5 227.5)" strokeWidth="1.2" />
        <circle cx="507.5" cy="227.5" r="2.5" fill="currentColor" />
      </g>
    </svg>
  );
};
